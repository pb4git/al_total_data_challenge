...
models = [
{
    ...
    'farms_to_use_as_features' : {1:[1, 4, 5, 6],
                                  2:[2, 6, 4, 1],
                                  3:[3, 1, 4, 6],
                                  4:[4, 1, 5, 6],
                                  5:[5, 1, 4, 6],
...
},
{
    ...
    'farms_to_use_as_features' : {1:[1, 4],
                                  2:[2, 6],
                                  3:[3, 1],
                                  4:[4, 1],
                                  5:[5, 1],
...
# data[['wp', 'forecast_for', 'horizon', 'farm_number']].set_index(['forecast_for', 'horizon', 'farm_number']).unstack().corr()