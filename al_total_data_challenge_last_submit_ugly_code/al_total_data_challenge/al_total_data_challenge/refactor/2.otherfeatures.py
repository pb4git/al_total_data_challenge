...
from package.ts_split_predict import ts_split_predict
for model in models:
    pred = ts_split_predict(data, split_dates_start, split_dates_end, features, model)
