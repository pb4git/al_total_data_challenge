...
from package.ts_split_predict import ts_split_predict, ts_split_predict_quant
for model in models:
    pred = ts_split_predict_quant(data, split_dates_start, split_dates_end, features, model)
