...
data = pd.read_parquet('data.1.1.0.0.parquet.gzip',
...
last_minute_features = [
    ...
    # 'v_horizon',
    # 'v_delta_horizon',
    'uv_norm_delta_horizon',
    'uv_delta_horizon_dot_uvn',
    'uv_delta_horizon_cross_uvn',
    'uv_delta_horizon_cross_uvn_abs',
    'ws_delta_horizon_mean_w3',
    # 'ws_delta_horizon_min_w3',
    # 'ws_delta_horizon_max_w3',
    'ws_delta_horizon_std_w3',
    'ws_delta_horizon_mean_w5',
    # 'ws_delta_horizon_min_w5',
    # 'ws_delta_horizon_max_w5',
    'ws_delta_horizon_std_w5',
    ]
